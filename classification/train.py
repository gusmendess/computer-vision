...
train_dataset = datasets.ImageFolder(str(ROOT_DIR / "datasets/cat_dog_dataset/train"), transform=transform)
train_loader = DataLoader(train_dataset, batch_size=BATCH_SIZE, shuffle=True)

val_dataset = datasets.ImageFolder(str(ROOT_DIR / "datasets/cat_dog_dataset/valid"), transform=transform)
val_loader = DataLoader(val_dataset, batch_size=BATCH_SIZE, shuffle=False)

test_dataset = datasets.ImageFolder(str(ROOT_DIR / "datasets/cat_dog_dataset/test"), transform=transform)
...
plt.tight_layout()
plt.savefig(str(BASE_DIR / 'validation_metrics.png'))
plt.show()
...
plt.tight_layout()
plt.savefig(str(BASE_DIR / 'test_metrics.png'))
plt.show()
